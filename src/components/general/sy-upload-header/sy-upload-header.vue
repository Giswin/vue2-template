<template>
    <vxe-modal :value="show" transfer width="455" :mask-closable="false" footer-hide :title="title" @close="closehead">
            ...
            <div style="position: absolute; bottom: 0px; left:0px; width: 100%;">
                <div class="vxe-row">
                    <div class="vxe-col--24 demo-col">
                        <div style="width: 100%;">
                            <el-button style="width: 48%;" @click.native="onOkClick">确定</el-button>
                            <el-button style="width: 48%;" @click.native="onCancelClick">取消</el-button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            backgroundImage: require("@/assets/ztbj.jpg"),
            format: ["jpg", "jpeg", "png"],
            imageUrl: "",
            defaultList: [],
            uploadList: [],
