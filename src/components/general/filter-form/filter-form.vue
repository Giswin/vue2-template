<template>
    <div>
        <el-button size="small" @click="drawer = true">{{$t('filter')}}</el-button>
        ...
        <template v-if="s_view_type == 1">
            <el-drawer :visible.sync="drawer" @close="close" :append-to-body="true" size="450px">
                <template v-slot:title>
                    <div class="title">{{$t('advancedFilterCondition')}}</div>
                </template>
                <div style="padding-right: 20px; padding-bottom: 70px;">
                    ...
                    <div class="drawer-bottom">
                        <ul>
                            <li>
                                <el-button type="primary" @click="submitForm" size="small" style="width: 100%;">{{$t('confirm')}}</el-button>
                            </li>
                            <li>
                                <el-button @click="resetForm" size="small" style="width: 100%;">{{$t('reset')}}</el-button>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <template v-if="s_view_type == 2">
            <vxe-modal :title="$t('filterConditionSetting')" :value="drawer" width="500" show-footer :mask-closable="false" @close="close">
                <template #default>
                ...
                <template v-slot:footer>
                    <div class="m-r" style="padding-right: 20px;padding-bottom: 10px;">
                        <ul>
                            <li>
                                <el-button type="primary" @click="submitForm" size="small" style="width: 80px;float: left;">{{$t('confirm')}}</el-button>
                                <el-button @click="resetForm" size="small" style="width: 80px;float: left;">{{$t('reset')}}</el-button>
                            </li>
                        </ul>
                    </div>
                </template>
