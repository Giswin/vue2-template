        ...
        <div class="drawer-body" :class="{'of' : dataset.length > 7 }">
            <el-form :model="dataset" :show-message="false" ref="ConditionForm" :label-width="label_width">
                ...
                <el-form-item v-for="(item, prop) in dataset" :label="item.title">
                    ...
                    <el-select v-if="item.type == 'select' &&item.options.config.tree" v-model="item.value" :multiple="item.options.config.multiple" filterable :placeholder="$t('select')" size="small" clearable collapse-tags @remove-tag="removeTag" style="width: 100%;">
                    ...
                    <template v-if="item.type == 'date'">
                        <el-col :span="11">
                            <el-form-item prop="date1">
                                <el-date-picker type="date" :placeholder="$t('selectDate')" v-model="item.value.start" style="width: 100%;" size="small" clearable value-format="yyyy-MM-dd" placement="bottom-start">
                                </el-date-picker>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="11">
                            <el-form-item prop="date2">
                                <el-date-picker type="date" :placeholder="$t('selectDate')" v-model="item.value.end" style="width: 100%;" size="small" clearable value-format="yyyy-MM-dd" placement="bottom-start">
                                </el-date-picker>
                            </el-form-item>
                        </el-col>
                    </template>
