...
const routes = [
	...
	},
	{
		...
		meta: {
			title:'合同打印(附件)',
			englishTitle:"Contract Print(Attach)",
			requireAuth: false,//需要登录显示
    		showHeader: false ,//头部显示
    		showNav:false,//菜单显示
    		showtag:false,//标签显示
