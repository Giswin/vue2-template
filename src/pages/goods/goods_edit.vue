<template>
    <div class="wrap">
        <vxe-modal ref="model1" :value="show" width="1100" resize height="650" show-footer destroy-on-close>
            <template v-slot:header>
                商品编辑
                <div class="model-header-r" v-show="goods_id!=0">
                    编码:{{goods_id}}
                </div>
                <div class="model-r">
            ...
            <div class="tabs">
                ...
                <div class="tabs-col" :class="{ show: selectTab == 1 }" @click="selectTab = 1">BOM信息</div>
            </div>
            <div v-show="selectTab==0">
                <div class="create-info">
                    <div>创建信息：<span>{{base_info.goods_creator}}</span><span>{{base_info.goods_create_time}}</span></div>
                    <div class="change-info">修改信息：<span>{{base_info.goods_updator}}</span><span>{{base_info.goods_update_time}}</span></div>
                </div>
                    ...
                    <el-row>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="definition">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="200">
                                                <el-select ref="depSelect" v-model="base_info.goods_dep_name" placeholder="请选择部门" size="small" clearable @clear="clearDep">
                                                    <el-tree ref="listTree" :data="allDep" :props="defaultProps" node-key="dep_id" @node-click="depClick"></el-tree>
                                                    <el-option v-for="item in allDep" :key="item.label" :value="item.value" :label="item.label" style="display: none;"></el-option>
                                                </el-select>
                                            </td>
                                            <th width="120" align="center"><span>*</span> 业务员</th>
                                            <td width="200">
                                                <el-select v-model="base_info.goods_salesman_name" size="small" clearable placeholder="请选择" @change="changeSales">
                                                    <el-option v-for="item in allPer" v-show="item.dep_id == base_info.goods_dep_id" :key="item.staff_id" :label="item.staff_name" :value="item.staff_name"></el-option>
                                                </el-select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <el-select ref="categorySelect" v-model="base_info.goods_category_name" placeholder="请选择" size="small" clearable @clear="clearCategory">
                                                    <el-tree ref="categoryTree" :data="category" :props="categoryProps" node-key="dictionary_id" @node-click="handleCategoryClick"></el-tree>
                                                    <el-option v-for="item in category" :key="item.dic_code" :value="item.dic_name" :label="item.dic_name" hidden></el-option>
                                                </el-select>
                                            </td>
                                        ...
                                        <tr>
                                            <th align="center"><span>*</span> 销售品名</th>
                                            <td>
                                                <el-input v-model="base_info.goods_sale_name" clearable></el-input>
                                            </td>
                                            <th align="center"> 采购品名</th>
                                            <td>
                                                <el-input v-model="base_info.goods_purchase_name" clearable></el-input>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_sale_unit" placeholder="请选择" size="small" filterable clearable @change="changeSalesUnit">
                                                    <el-option v-for="item in TY_JLDW" :key="item.dictionary_id" :value="item.dic_name" :label="item.dic_name"></el-option>
                                                </el-select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_cus_name" placeholder="请输入关键词选择" size="small" clearable filterable remote :remote-method="remoteMethod1" @change="changeCustomer" @clear="clearCustomer">
                                                    <el-option v-for="item in cusOptions" :key="item.cus_id" :value="item.cus_name" :label="item.cus_name"></el-option>
                                                </el-select>
                                            </td>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_ven_name" placeholder="请输入关键词选择" size="small" clearable filterable remote :remote-method="remoteMethod2" @change="changeVender" @clear="clearVender">
                                                    <el-option v-for="item in venOptions" :key="item.ven_id" :value="item.ven_name" :label="item.ven_name"></el-option>
                                                </el-select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_stock_org_name_ebs" placeholder="请选择" @change="changeStockHS" clearable>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_name_ebs" placeholder="请选择" filterable @change="changeEBSGoodsHS" clearable>
                                                    <el-option v-for="item in ebsGoodsHS" v-show="ebsGoodsHS.length>0" :value="item.description" :key="item.inventory_item_id" :label="item.description"></el-option>
                                                </el-select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_stock_org_name_ebs_hk" placeholder="请选择" @change="changeStockHK" clearable>
                                            ...
                                            <td>
                                                <el-select v-model="base_info.goods_name_ebs_hk" placeholder="请选择" filterable clearable @change="changeStockHK">
                                                    <el-option v-for="item in ebsGoodsHK" v-show="ebsGoodsHK.length>0" :value="item.description" :key="item.inventory_item_id" :label="item.description"></el-option>
                                                </el-select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th align="center"> 开启/禁用</th>
                                            <td>
                                                <el-switch v-model="isOpen" active-color="#13ce66" inactive-color="#ddd" active-text="开启" inactive-text="禁用" @change="switchChange">
                                                </el-switch>
                                            </td>
                                            <th></th>
                                            <td></td>
                            ...
                            <div class="statistics-info">
                                ...
                                <div class="statistics-main">
                                    <div class="wrap-box" v-for="(item,index) in labelList" :key="index">
                                        ...
                                        <div class="value">
                                            <el-select v-model="item.selected" size="small" @change="changeLabel" clearable>
                        ...
                        <el-col :span="8">
                            <div class="img-info">
                                ...
                                <div class="image-box" @click="showview=true">
                                    <img :src="base_info.goods_pic_url" alt="">
                                    <syUploadHeader :show.sync="showview" @on-ok="saveHeaderImg" @on-cancel="showview = false" :fileUploadApi="upyun.upyunUrl" :oss="upyun.getyunUrl" :formData="uploadFormData" :maxSize="1024" :src="base_info.goods_pic_url"></syUploadHeader>
                            ...
                            <vxe-table-column field="goods_name_ebs_hk" title="EBS商品(香港)" width="100" align="center" :edit-render="{autofocus:'.el-input__inner',autoselect:true}">
                                <template #edit="{row}">
                                    <el-select v-model="row.goods_name_ebs_hk" placeholder="请选择" clearable filterable @change="changeEBSGoodsHK2(row)" size="small">
                                        <el-option v-for="item in ebsGoodsHK2" v-show="ebsGoodsHkkK2.length>0" :value="item.description" :key="item.segment1" :label="item.description"></el-option>
                                    </el-select>
                                </template>
                            </vxe-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            base_info: {
                ...
                goods_create_time: this.getTime, //创建时间
                goods_updator: "", //修改人名称
            ...
            required: {
                ...
                goods_sale_name: "销售品名", //销售品名
                goods_name_ebs: "EBS商品名",
            },
            flag: true,
            creator_dep: "",
            updator_dep: "",
    ...
    methods: {
        ...
        async getDep() {
            ...
            this.allDep = Object.freeze(list.data);
                            ...
                            if (data.dep_id == this.$store.state.user.edep) {
                                ...
                                if (data.dep_ebs_org_id_hk) {
                                    ebsApi
                                        ...
                                        .then((res) => {
                                            this.initGoodsHK = Object.freeze(
                                                res.data
                                            );

                                            this.ebsGoodsHK = this.initGoodsHK;
                                        });
                                }
                            }
                        });
        ...
        // 业务员
        async getPer() {
            let data = await this.$dmBaseSet.personData();
            this.allPer = Object.freeze(data.list);
            console.log("allPer", this.allPer);
        },

        // 客户
        async getCus() {
            let data = await ifsApi.getCustomerList();
            this.allCus = Object.freeze(data.page_list);
        },
        // 供应商
        async getVender() {
            let res = await ifsApi.getVenderList();
            this.vender = Object.freeze(res.page_list);
            console.log("供应商", this.vender);
        },
        // 获取字典相关
        async getDicData() {
            // 获取字典数据
            ifsApi
                .dicData(
                    "TY_JLDW,CBM_GOODS_CATEGORY,CBM_GOODS_STATISTICS_LABEL"
                )
                .then((data) => {
                    console.log("dic", data);
                    this.TY_JLDW = Object.freeze(data["TY_JLDW"].children); //计量单位
                    this.category = Object.freeze(
                        data["CBM_GOODS_CATEGORY"].children
                    ); //商品大类
                    this.labelList =
                        data["CBM_GOODS_STATISTICS_LABEL"].children; //统计标签
        ...
        // 商品信息
        getGoodsInfo(id) {
            goodsApi.getGoodsInfo(id).then((res) => {
        ...
        changeCustomer(value) {
            if (value) {
                this.allCus.forEach((item) => {
                    if (item.cus_name == value) {
                        this.base_info.goods_cus_id = item.cus_id;
                    }
                });
            } else {
        ...
        remoteMethod1(query) {
            if (query !== "") {
                this.cusOptions = this.allCus.filter((item) => {
                    return (
                        item.cus_name
                            .toLowerCase()
        ...
        changeVender(value) {
            if (value) {
                this.vender.forEach((item) => {
                    if (item.ven_name == value) {
                        this.base_info.goods_ven_id = item.ven_id;
                    }
                });
            } else {
        ...
        remoteMethod2(query) {
            if (query !== "") {
                this.venOptions = this.vender.filter((item) => {
                    return (
                        item.ven_name
                            .toLowerCase()
                            .indexOf(query.toLowerCase()) > -1
            ...
            if (value) {
                this.ebsGoodsHS.forEach((item) => {
                    if (item.description == value) {
                        this.base_info.goods_id_ebs = item.inventory_item_id;
                    }
                });
            } else {
                this.base_info.goods_id_ebs = null;
            }
        },
        changeEBSGoodsHk(value) {
            if (value) {
                this.ebsGoodsHK.forEach((item) => {
                    if (item.description == value) {
                        this.base_info.goods_id_ebs_hk = item.inventory_item_id;
                    }
                });
            } else {
                this.base_info.goods_id_ebs_hk = null;
            }
        },
        switchChange(value) {
            this.isOpen = value;
        ...
        remoteMethod3(query) {
            if (query !== "") {
                this.venOptions2 = this.vender.filter((item) => {
                    return (
                        item.ven_name
                            .toLowerCase()
                            .indexOf(query.toLowerCase()) > -1
        ...
        edit_state: {
            handler(newVal, oldVal) {
                if (newVal == 1) {
                    ...
                    this.base_info.goods_create_time =
                        this.$general.getNowDateTime();
                ...
                if (newVal == 2) {
                    // console.log("标签", this.base_info.goods_labels);
                    // let goods_labels = this.base_info.goods_labels;
                    // if (goods_labels) {
                    //     goods_labels.forEach((item) => {
                    //         this.labelList.forEach((data) => {
