...
<template>
    <div>
        <div class="col-left">
            <div style="width: 100%; height: 95%" id="container2"></div>
        </div>
        <div class="col-right">
            <vxe-table ref="userTable" border :data="pieList" size="small" auto-resize height="100%" show-footer :footer-method="footerMethod" :column-config="{ minWidth: 80 }" class="mytable-scrollbar" show-overflow highlight-current-row highlight-hover-row resizable>
                ...
                <vxe-table-column field="order_dep_name" title="部门" sortable sort-by="order_dep_name" :width="$columns.info.medium" header-align="center">
                </vxe-table-column>
            ...
            this.chart
                ...
                .label("proportion", {
                    ...
                    content: (data) => {
                        ...
                        return `${data.order_dep_name}: ${num}%`;
                    },
                })
                .tooltip(
                    "order_dep_name*order_amount_usd",
                    (order_dep_name, order_amount_usd) => {
