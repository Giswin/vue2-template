...
<template>
    <div>
        <div class="col-left">
            <div style="width:100%; height:95%;" id="shContainer3"></div>
        </div>
        <div class="col-right">
            <vxe-table ref="userTable" border :data="pieList" size="small" auto-resize height="100%" show-footer :footer-method="footerMethod" :column-config="{minWidth:80}" class="mytable-scrollbar" show-overflow highlight-current-row highlight-hover-row>
                ...
                <vxe-table-column field="shn_sales_name" title="业务员" :width="$columns.info.medium" header-align="center">
                </vxe-table-column>
            ...
            this.chart
                ...
                .label("proportion", {
                    ...
                    content: (data) => {
                        ...
                        return `${data.shn_sales_name}: ${num}%`;
                    },
                })
                .tooltip(
                    "shn_sales_name*shn_amount_a",
                    (shn_sales_name, shn_amount_a) => {
