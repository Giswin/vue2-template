<template>
    <div>
        <div class="contract-wrap">
            ...
            <div class="class-title">
                ...
                <div class="m-r" style="margin-top: -8px;">
                   <el-button size="small" v-if="orderData.ode_bus_type_id_ebs=='1285'" @click="modalContractProcess=true;contract_id=null">新增库存加工</el-button>
                </div>
            </div>

            <div class="contract-table">
                <vxe-table border ref="processTable" :data="processData" auto-resize resizable show-overflow size="small" class="mytable-scrollbar" max-height="100%" :column-config="{minWidth:120}">
                    ...
                    <vxe-table-column field="contract_type" title="合同类型" align="left" header-align="center" min-width="80">
                        <template v-slot="{row}">
                            <span v-if="row.contract_type == 'DIS'">双经销</span>
                            <span v-if="row.contract_type == 'P_AGENCY'">纯加工</span>
                        </template>
                    </vxe-table-column>
        ...
        <!-- 加工合同编辑 -->
		<contract_process_edit v-if="modalContractProcess" :show.sync="modalContractProcess" :orderData="orderData" :contract_id="contract_id" @afterSaveProContract="saveProContract()"></contract_process_edit>
        <!-- 合同变更页面 -->
