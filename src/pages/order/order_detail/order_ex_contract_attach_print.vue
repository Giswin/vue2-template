...
<template>	
	<div :style="{'padding-bottom': type == 'aprv' ? '130px':'0px'}">
		...
		<div style="width:890px; min-height:1290px; position: relative; margin: auto;background: #fff;padding: 20px;border: 1px solid #000;margin-top: 10px;color: #000;">
						...
						<td>
							<div class="print-head">
								...
								<div class="ewm">
									...
									MOULD_CODE: cbm_ex_contract_attach 
					...
					<tr>
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table-form">
								...
								<tbody>
									<tr >
										<td><b style="font-size: 16;">As Per Attached Sheet(s)</b></td>
									</tr>
									<tr>
										<td></td>
										<td align="right"></td>
		...
		<div style="width:890px; height:1280px; margin: auto;background: #fff;padding: 20px;border: 1px solid #000;margin-top: 10px;color: #000;">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tbody>
					<div style="font-size: 20px;"><b>Attached Sheet(s)</b></div>
					<tr>
                ...
                ifsApi.dicData( "TY_JLDW").then((res) => {
                    ...
                    this.orderGoods.forEach(item => {
                        unitList.forEach(index => {
                            if(item.dic_code==index.goods_sale_unit_code){
