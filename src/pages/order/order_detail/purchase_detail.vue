    ...
    <div class="detail-fixed of">
        <div class="main-invoice">
            <div class="header">
                ...
                <div class="title">
                    采购合同详情<br>Purchase Contract Detail
                </div>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="definition">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span v-if="base_info.contract_type == '05'">国内采购</span>
                                        <span v-if="base_info.contract_type == '01'">进口采购</span>
                                    </td>
                                </tr>
                                <tr>
            ...
            <div style="margin: 0 10px;">
                ...
                highlight-current-row highlight-hover-row show-footer :footer-method="footerMethod" show-overflow>
                    ...
                    <vxe-table-column field="contract_detail_article_number" title="采购货号" width="100" align="center" >
                    </vxe-table-column>
                    <vxe-table-column field="contract_detail_name" title="采购品名" width="100" header-align="center" align="left" >
                    </vxe-table-column>
                    ...
                    <vxe-table-column field="contract_detail_unit" title="单位" width="70" header-align="center" align="center" >
                    </vxe-table-column>
                    <vxe-table-column field="contract_detail_price" title="单价" width="100" header-align="center" align="right" >
                    </vxe-table-column>
                    <vxe-table-column field="contract_detail_tax_rate" title="税率" width="60" header-align="center" align="right" formatter="formatAmount" >
                    </vxe-table-column>
                    <vxe-table-column field="contract_detail_amount" title="金额" header-align="center" align="right" formatter="formatAmount" >
                    </vxe-table-column>
