...
<template>
	<vxe-modal ref="model1" :value="show" width="600" resize height="350" transfer show-footer destroy-on-close>
		...
		<template v-slot:footer>
			<div class="m-r">
				<el-button type="submit" @click="orderChange" size="small">确定</el-button>
...
<script>
	...
	export default {
		...
		methods:{
			...
			//订单变更
			orderChange(){
				orderApi.orderChange(this.order_id,this.change_reason).then((res)=>{
					if(res.code == 0){
