	...
	<div :style="{'padding-bottom':flag=='approve'? '130px' : '0px'}">
		...
		<div style="width:890px; margin: auto;padding-top: 10px;" v-if="!printting">
			<div class="m-r">
				...
				<!-- <el-button size="small" @click="fresh_apvstate()" >关闭</el-button> -->
						...
						<td>
							<div class="print-head">
								...
								<div class="ewm">
									...
									MOULD_CODE: ${'cbm_order_process_contract '} 
		...
		<!-- <approve_form v-show="value1" @after-save="fresh_apvstate" :wf_code="$config.EBS_AUDIT" :wfr_object_id='ebs_data.oce_id' :show.sync="value1"></approve_form> -->
