...
<template>	
	<div :style="{'padding-bottom': type == 'aprv' ? '130px':'0px'}">
		...
		<div style="width:980px; min-height:1270px; position: relative; margin: auto; position: relative;background: #fff;padding: 20px;border: 1px solid #000;margin-top: 10px;sy-color: #000;">
		...
		<!-- <approve_form v-if="type == 'aprv'" :state="ebs_data.odsc_state" @before-save="getOrderSalesEbsList" @after-save="fresh_apvstate" :wf_code="$config.EBS_ORDER_AUDIT" :wfr_object_id='id' :show.sync="value1"></approve_form> -->
	</div>
</template>
