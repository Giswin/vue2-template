...
const getLunar = function(date1) {
    ...
    function solarDay3() {
        var sTermInfo = new Array(0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072,
            240693, 263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224, 483532,
            504758)
        
        var solarTerm = new Array("小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑",
        ...
        var sFtv = new Array("0101*元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0315 消费者权益日",
            ...
            "0801 建军节", "0808 父亲节", "0909 毛主席逝世纪念", "0910 教师节", "0928 孔子诞辰", "1001*国庆节",
        ...
        for (let i in sFtv)
            if (sFtv[i].match(/^(\d{2})(\d{2})([\s\*])(.+)$/)) {
                tmp1 = Number(RegExp.$1) - (GM + 1)
                tmp2 = Number(RegExp.$2) - GD
                if (tmp1 == 0 && tmp2 == 0) solarFestival = RegExp.$4
            }
        //节气
        tmp1 = new Date((31556925974.7 * (GY - 1900) + sTermInfo[GM * 2 + 1] * 60000) + Date.UTC(1900, 0, 6, 2, 5))
        tmp2 = tmp1.getUTCDate()
        if (tmp2 == GD) solarTerms = solarTerm[GM * 2 + 1]
        ...
        return {
            ...
            solarFestival: solarFestival, // 公历节日
            solarTerm: solarTerms // 二十四节气
        };
    }
    ...
    return Object.assign({}, calendar, solarDay3())
